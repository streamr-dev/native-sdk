...
protected:
    ...
    DhtAddress node1 = Identifiers::getNodeIdFromPeerDescriptor(mockPeerDescriptor1);
    DhtAddress node2 = Identifiers::getNodeIdFromPeerDescriptor(mockPeerDescriptor2);
