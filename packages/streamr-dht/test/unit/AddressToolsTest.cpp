...
TEST_F(AddressToolsTest, GetAddressFromIceCandidate_ExtractIPv4AddressFromICEHostCandidate) { // NOLINT
...
TEST_F(AddressToolsTest, GetAddressFromIceCandidate_ExtractIPv4AddressFromICEServerReflexiveCandidate) { // NOLINT
...
TEST_F(AddressToolsTest, IsPrivateIPv4_ReturnTrueForRange172_16_0_0_12) { // NOLINT
    EXPECT_TRUE(AddressTools::isPrivateIPv4("172.16.130.131"));  
}

TEST_F(AddressToolsTest, IsPrivateIPv4_ReturnTrueForRange192_168_0_0_16) { // NOLINT
...
TEST_F(AddressToolsTest, IsPrivateIPv4_ReturnTrueForLocalhostIPAddress) { // NOLINT
