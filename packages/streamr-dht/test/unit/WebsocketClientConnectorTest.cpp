...
TEST_F(
    WebsocketClientConnectorTest, IsPossibleToFormConnectionNodeWithoutServer) {
...
TEST_F(
    WebsocketClientConnectorTest, IsPossibleToFormConnectionNodeWithTLSServer) {
...
TEST_F(
    ...
    IsPossibleToFormConnectionNodeWithNonTLSServer) {
    connector->setLocalPeerDescriptor(
...
TEST_F(
    WebsocketClientConnectorTest,
    IsPossibleToFormConnectionNodeWithNonTLSServerInLocalNetwork) {
...
TEST_F(WebsocketClientConnectorTest, IsPossibleToFormConnectionBrowser) {
    connector->setLocalPeerDescriptor(
