...
echo "Running the publisher example: ./build/publisherexample_cpp $PROXY_URL $PROXY_ETHEREUM_ADDRESS $STREAM_PART_ID"
# Run the publisher example with the proxy address
./build/publisherexample_cpp $PROXY_URL $PROXY_ETHEREUM_ADDRESS $STREAM_PART_ID
