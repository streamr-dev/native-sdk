      ...
      if(VCPKG_JSON_DECODED)
          ...
          if(MONOREPO_EXISTS)
              ...
              foreach(idx RANGE "${END_INDEX}")
                  ...
                  list(APPEND CMAKE_PREFIX_PATH ${CMAKE_CURRENT_SOURCE_DIR}/../${MONOREPO_DEPENDENCY}/build/vcpkg_installed/${VCPKG_TARGET_TRIPLET}/share)
                  list(APPEND CMAKE_PREFIX_PATH ${CMAKE_CURRENT_SOURCE_DIR}/../${MONOREPO_DEPENDENCY}/build)
